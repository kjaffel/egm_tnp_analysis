...
baseOutDir = 'results/TnP_RunIISummer20ULver21-07-22__ext3/UL2016_postVFP/tnpEleTrig/et' 
...
biningDef = [
    ...
    { 'var' : 'probe_sc_et' , 'type': 'float', 'bins': [10.0, 12.0, 14.0, 16.0, 18.0, 20.0, 21.0, 22.0, 23.0, 24.0, 25.0, 27.0, 28.5, 30.0, 35.0, 40.0, 45.0, 50.0,60.0,70.0,80.0,100.0, 150.0, 200.0, 250.0, 500.0, 600.0] },
]
