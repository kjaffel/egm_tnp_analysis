...
baseOutDir = 'results/TnP_RunIISummer20ULver21-07-22__ext3/UL2016_postVFP/tnpEleTrig/nVtx' 
...
#############################################################
biningDef = [
   { 'var' : 'probe_sc_eta' , 'type': 'abs_float', 'bins': [0.0, 0.8, 1.4442, 1.566, 2.0, 2.5] },
